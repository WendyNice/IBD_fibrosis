...
write.xlsx(df_in, file = pathJoin(save_path, 'bac_feature_select_HC_FDR_0.1.xlsx'), rowNames=TRUE)
write.xlsx(compare_Control, pathJoin(save_path, 'bacterium_p_value_hc_FDR_0.1.xlsx'), rowNames=TRUE)
