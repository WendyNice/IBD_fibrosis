...
data_fea <- read_excel(pathJoin(save_path, 'fecal_met_features.xlsx'), sheet = 1)
...
write.xlsx(association_df, file = pathJoin(save_path, 'association_BF1_fecal_img.xlsx'), rowNames=TRUE)
...
write.xlsx(association_df, file = pathJoin(save_path, 'association_BF2_fecal_img.xlsx'), rowNames=TRUE)
