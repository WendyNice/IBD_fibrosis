...
# blo_feature1 <- read_excel(pathJoin(save_path_blood, 'association_BF1_blood_img.xlsx'), sheet = 1)
# blo_feature1 <- blo_feature1[blo_feature1$Pvalue < 0.05, ]
# blo_feature1 <- unique(blo_feature1$Feature)
# blo_feature2 <- read_excel(pathJoin(save_path_blood, 'association_BF2_blood_img.xlsx'), sheet = 1)
...
write.xlsx(association_df, file = pathJoin(save_path, 'association_BF1_bac_blood.xlsx'), rowNames=TRUE)
...
write.xlsx(association_df, file = pathJoin(save_path, 'association_BF2_bac_blood.xlsx'), rowNames=TRUE)
