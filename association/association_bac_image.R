...
write.xlsx(association_df, file = pathJoin(save_path, 'association_BF1_bac_img.xlsx'), rowNames=TRUE)
...
write.xlsx(association_df, file = pathJoin(save_path, 'association_BF2_bac_img.xlsx'), rowNames=TRUE)
