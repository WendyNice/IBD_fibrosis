...
color_link = c(rgb(205/255,128/255,128/255,alp), 
               ...
               # rgb(255/255,182/255,193/255,alp), 
...
direct_asso_path <- './20230514/mediation_meta/results/blood'
blood_name_ref <- read_excel(pathJoin(direct_asso_path, 'blood_colnames_ref.xlsx'), sheet = 1)

media_df <- read_excel(pathJoin(save_path_df, 'mediation_blo_BF2.xlsx'), sheet = 1)
...
asso_df <- read_excel(pathJoin(direct_asso_path, 'association_BF2_blood_img.xlsx'), sheet = 1)
